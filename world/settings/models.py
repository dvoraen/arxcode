...
class CategorySettings(SharedMemoryModel):
    ...
    # The category's name.  Displayed in tables.
    category = "Unknown"
    # Non-setting fields; exclude from tables and copying.  Set for fields
    ...
    # display in the settings tables generated by get_table().
    color_settings = ()
    ...
    def has_setting(self, setting_name) -> bool:
        """
    ...
    def get_setting(self, setting_name):
        ...
        # Until we upgrade to Evennia 1.0+, EvTable will
        # strip color codes from an ANSIString, so strings like
    ...
    def copy_one(self, other, setting_name):
        """
        Copies the specified setting into other.
        """
        if self.category != other.category:
            raise SettingsError(
                f"categories must match when attempting to copy (self: {self.category}, other:{other.category})"
            )
...
class PlayerSettings(CategorySettings):
    ...
    valid_categories = ("all", "general", "comm", "rp")
    exclude = ("character",)
